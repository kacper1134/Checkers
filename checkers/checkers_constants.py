...
BUTTON_SELECT_TEXT_COLOR = BLACK
...
BUTTONS_IN_ROW = 3
BUTTONS_IN_COLUMN = 6
BUTTONS_WIDTH = WIDTH // BUTTONS_IN_ROW
BUTTONS_HEIGHT = HEIGHT // BUTTONS_IN_COLUMN
BUTTON_PADDING = BUTTONS_WIDTH // 5
BUTTON_BORDER = BUTTONS_WIDTH // 10
BUTTON_FONT_SIZE = 20
